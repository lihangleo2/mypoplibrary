package com.atmanleo.mypoplibrary;
...
public class CommonPopupWindow extends PopupWindow {
    ...
    public void showUpView(View view) {
        this.setAnimationStyle(R.style.MainPopAnim_top);
    ...
    public void showDownView(View view) {
        this.setAnimationStyle(R.style.MainPopAnim_bottom);
    ...
    public void showLeftView(View view) {
        this.setAnimationStyle(R.style.MainPopAnim_left);
    ...
    public void showRightView(View view) {
        this.setAnimationStyle(R.style.MainPopAnim_right);
        this.showAsDropDown(view, view.getMeasuredWidth(), -(this.getHeight() + view.getMeasuredHeight()) / 2);
    }
    ...
    public static class Builder {
        ...
        public CommonPopupWindow create() {
            ...
            UIUtil.measureWidthAndHeight(popupWindow.controller.mPopupView);
            return popupWindow;
        }
    }
}
